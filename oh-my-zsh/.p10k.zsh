# Generated by Powerlevel10k configuration wizard on 2024-12-19 at 12:59 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    dockercontext           #Mika local docker context
  ...
  function instant_prompt_dockercontext() {
    prompt_dockercontext
  }

  function prompt_dockercontext() {
    if type "docker" > /dev/null; then
      p10k segment -f yellow -t $(docker context show)
    fi
  }
