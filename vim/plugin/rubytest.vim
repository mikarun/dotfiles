...
if !exists("g:rubytest_cmd_spec")
  let g:rubytest_cmd_spec = "bundle exec rspec --format Fuubar --no-color %p"
endif
if !exists("g:rubytest_cmd_example")
  "let g:rubytest_cmd_example = "bundle exec rspec --format Fuubar --no-color -d %p -l %c"
  let g:rubytest_cmd_example = "bundle exec rspec --format Fuubar --no-color %p:%c"
endif
